package com.privatepe.host.status_videos.model;
...
import com.privatepe.host.status_videos.PausableProgressBar;
...
public class StatusProgressView extends LinearLayout {
    ...
    private static final String TAG = StatusProgressView.class.getSimpleName();
    ...
    public StatusProgressView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     */
    public void setStoriesCountWithDurations(@NonNull List<Long> durations) {
    ...
    private PausableProgressBar.Callback callback(final int index) {
        return new PausableProgressBar.Callback() {
            ...
            public void onStartProgress() {
                current = index;
                Log.e("pause_resume_test", "onStartProgress:  index "+current );
            }
