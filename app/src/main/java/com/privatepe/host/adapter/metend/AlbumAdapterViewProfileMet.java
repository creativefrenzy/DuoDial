...
import com.privatepe.host.dialogs.PictureViewOnViewProfileAlbumMet;
...
public class AlbumAdapterViewProfileMet extends RecyclerView.Adapter<AlbumAdapterViewProfileMet.ViewHolder> {
    ...
    public AlbumAdapterViewProfileMet(Context context, List<com.privatepe.host.response.metend.UserListResponseNew.FemaleImage> list, boolean canOpen) {
