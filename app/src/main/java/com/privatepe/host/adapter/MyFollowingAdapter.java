...
import com.privatepe.host.activity.DetailedFansAndFollowers;
import com.privatepe.host.model.DataFollowers;
import com.privatepe.host.model.MyFollowerUserData;
import com.privatepe.host.model.MyTopFansData;
...
public class MyFollowingAdapter extends RecyclerView.Adapter<MyFollowingAdapter.myViewHolder>{
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (MyFollowersData != null && MyFollowersData.size() > position) {
            ...
            Glide.with(mContext)
                    .load(user.getProfile_images().get(0).getImageName())
                    .into(holder.im_profile_pic);
            Log.e("image123", "::"+user.getProfile_images().get(0).getImageName());
