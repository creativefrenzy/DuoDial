...
import com.privatepe.host.databinding.DialogReportBinding;
...
public class ReportDialog extends Dialog {
    ...
    public class EventHandler implements ApiResponseInterface {
        ...
        public void reportUser(int isBlock) {
            ...
            new ApiManager(getContext(), this).reportUser(id, String.valueOf(isBlock), radioButton.getText().toString(), binding.reportReason.getText().toString());
        }
