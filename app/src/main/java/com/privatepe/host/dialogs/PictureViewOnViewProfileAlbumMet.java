...
public class PictureViewOnViewProfileAlbumMet extends Dialog {
    ...
    public PictureViewOnViewProfileAlbumMet(Context context, List<com.privatepe.host.response.metend.UserListResponseNew.FemaleImage> profile_images, int selectedPic) {
