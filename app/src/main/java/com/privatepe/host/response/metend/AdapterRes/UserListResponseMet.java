package com.privatepe.host.response.metend.AdapterRes;
...
public class UserListResponseMet implements Serializable {
    ...
    public static class Result implements Serializable {
        ...
        String last_page_url, first_page_url, path, next_page_url, prev_page_url, level;
    ...
    public static class Data implements Serializable {
        int favorite_count, favorite_by_you_count, profile_id, call_rate, is_online, is_busy, audio_call_rate, total_coins,call_price;
