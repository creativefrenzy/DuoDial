package com.privatepe.app.fudetector.view;

import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.STR_FILTER_LEVEL;
import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.getValue;
import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.isOpen;
import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.sFilter;
import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.sFilterLevel;
import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.sHeavyBlur;
import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.sSkinDetect;
import static com.privatepe.app.fudetector.view.entity.BeautyParameterModel.setValue;
...
import com.privatepe.app.fudetector.faceunity.OnFUControlListener;
import com.privatepe.app.fudetector.faceunity.entity.Effect;
import com.privatepe.app.fudetector.faceunity.entity.FaceMakeup;
import com.privatepe.app.fudetector.faceunity.entity.Filter;
import com.privatepe.app.fudetector.faceunity.entity.MakeupItem;
import com.privatepe.app.fudetector.view.adapter.BaseRecyclerAdapter;
import com.privatepe.app.fudetector.view.adapter.VHSpaceItemDecoration;
import com.privatepe.app.fudetector.view.entity.BeautyParameterModel;
import com.privatepe.app.fudetector.view.entity.EffectEnum;
import com.privatepe.app.fudetector.view.entity.FaceMakeupEnum;
import com.privatepe.app.fudetector.view.entity.FilterEnum;
import com.privatepe.app.fudetector.view.seekbar.DiscreteSeekBar;
import com.privatepe.app.fudetector.view.utils.OnMultiClickListener;
    ...
    private void initViewBottomRadio() {
        ...
        mBottomCheckGroup.setOnCheckedChangeListener(new CheckGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CheckGroup group, int checkedId) {
                Log.e("checkedIdLog", "checkedId = " + checkedId);
