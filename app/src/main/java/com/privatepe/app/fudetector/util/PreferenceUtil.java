package com.privatepe.app.fudetector.util;
...
public class PreferenceUtil {
    ...
    private PreferenceUtil() {
        mSharedPreferences = AppLifecycle.getInstance().getSharedPreferences(SHARE_PREFERENCE_NAME, AppCompatActivity.MODE_PRIVATE);
    }
