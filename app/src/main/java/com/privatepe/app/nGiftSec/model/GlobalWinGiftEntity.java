...
public final class GlobalWinGiftEntity {
    ...
    public GlobalWinGiftEntity(long fromUsedrID, String fromNickName, int fromSex, String fromUserPic, String fromVLevel, int giftCount, String giftName, String giftType,
