...
import static com.privatepe.app.utils.Constant.BUY_STORE_ITEM;
...
import static com.privatepe.app.utils.Constant.GET_STORE_TAB_LIST;
...
//                    Log.e("errorResponce", response.body().getError());
    ...
    public void getUserListNextPage(String pageNumber, String search) {
        //  showDialog();
        Call<com.privatepe.app.model.UserListResponse> call = apiService.getUserList(authToken, "application/json", search, pageNumber, "16", String.valueOf(new SessionManager(mContext).gettLangState()));
        // Log.e("authToken", authToken);
       /* Log.e("authToken", authToken);
        Log.e("pageNumber", pageNumber);
        Log.e("lanID", String.valueOf(new SessionManager(mContext).gettLangState()));
*/
        call.enqueue(new Callback<com.privatepe.app.model.UserListResponse>() {
            @Override
            public void onResponse(Call<com.privatepe.app.model.UserListResponse> call, Response<com.privatepe.app.model.UserListResponse> response) {
            ...
            @Override
            public void onFailure(Call<com.privatepe.app.model.UserListResponse> call, Throwable t) {
                //   closeDialog();
...
*/
    ...
    public void getPopularList(String pageNumber, String search) {
        //showDialog();
        Call<com.privatepe.app.model.UserListResponse> call = apiService.getPopulartList(authToken, "application/json", search, pageNumber, "16", String.valueOf(new SessionManager(mContext).gettLangState()));
    ...
    public void getUserListNearbyNextPage(String pageNumber, String search) {
        //  showDialog();
        Call<com.privatepe.app.model.UserListResponse> call = apiService.getNearbyList(authToken, "application/json", search, pageNumber, "16", String.valueOf(new SessionManager(mContext).gettLangState()));
...
*/
    ...
    public void getProfileDataNew(String id, String search) {
        //showDialog();
        Log.e("newProfileFemaleId", id);
        Call<com.privatepe.app.response.metend.UserListResponseNew.UserListResponseNewData> call = apiService.getProfileDataNew(authToken, "application/json", search, "", id, String.valueOf(new SessionManager(mContext).gettLangState()));
        // Log.e("lanID", String.valueOf(new SessionManager(mContext).gettLangState()));
        call.enqueue(new Callback<com.privatepe.app.response.metend.UserListResponseNew.UserListResponseNewData>() {
            @Override
            public void onResponse(Call<com.privatepe.app.response.metend.UserListResponseNew.UserListResponseNewData> call, Response<com.privatepe.app.response.metend.UserListResponseNew.UserListResponseNewData> response) {
                Log.e("getprofiledata", new Gson().toJson(response.body()));
                if (response.isSuccessful() && response.body() != null) {
            ...
            @Override
            public void onFailure(Call<com.privatepe.app.response.metend.UserListResponseNew.UserListResponseNewData> call, Throwable t) {
                //     closeDialog();
                Log.e("getprofiledataerror", t.getMessage());
                //  Toast.makeText(mContext, "Network Error", Toast.LENGTH_LONG).show();
            }
