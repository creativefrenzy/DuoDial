...
public class OfflineCoinSellingWebActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_coin_selling_web);

        webView = (WebView) findViewById(R.id.webvview);
        rl_close = (RelativeLayout) findViewById(R.id.rl_close);
        url = "https://ringlive.in//banner/offline_recharge.html";
