...
import com.privatepe.app.dialogs.PictureViewOnViewProfileAlbumMet;
...
public class AlbumAdapterViewProfileMet extends RecyclerView.Adapter<AlbumAdapterViewProfileMet.ViewHolder> {
    ...
    public AlbumAdapterViewProfileMet(Context context, List<com.privatepe.app.response.metend.UserListResponseNew.FemaleImage> list, boolean canOpen) {
