...
import com.klive.app.databinding.ActivityStoreBinding;
import com.klive.app.response.metend.store.adapters.MainUpperTabPagerAdapter;
import com.klive.app.response.metend.store.dialog.StoreItemPurchaseDialog;
import com.klive.app.response.metend.store.dialog.UseOrRemoveItemDialog;
...
import com.klive.app.response.metend.store.response.store_list.StoreItemModel;
...
public class StoreActivity extends BaseActivity {
    ...
    private void setupUpperTabs() {
        ...
        MainUpperTabPagerAdapter adapter = new MainUpperTabPagerAdapter(getSupportFragmentManager(), upperTabsFragmentList, new OnStoreItemClickListener() {
            @Override
            public void onStoreItemClick(com.klive.app.response.metend.store_list.StoreItemModel storeItemModel, String type) {
